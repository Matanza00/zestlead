// src/components/charts/AreaChartComponent.js
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none">
                ...
                <defs>
                  <radialGradient id="paint0_radial_59_929" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(22.4957 35.4552) rotate(-105.581) scale(39.6972 35.3611)">
                    <stop stopColor="#BCF1A5"/><stop offset="1" stopColor="#285B19"/>
                  </radialGradient>
        ...
        <div className="h-52">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={areaChartData} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
              ...
              <XAxis dataKey="name" stroke="#9ca3af" fontSize={12} tickLine={false} axisLine={{ stroke: '#e5e7eb' }} dy={10}/>
              <YAxis stroke="#9ca3af" fontSize={12} tickLine={false} axisLine={false} />
              <Tooltip />
              <Area type="linear" dataKey="value" stroke="#10B981" fill="url(#revenueGradient)" strokeWidth={2} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
